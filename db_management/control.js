...
const { checkAccountNFTs, nextNFT, checkAccountBadges } = require(appRoot+'/hedera/request');
...
module.exports = {
    ...
    lookForDoodles: (db, account_id, token_id, callback) => {
    ...
    lookForBadges: async (db,account_id,badge,callback) => {
